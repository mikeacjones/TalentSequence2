...
local WOWHEAD_TALENT_NAME_MAP = {
    ...
    tbc = {
        ...
        WARLOCK = {
            [0] = {
                a = "Suppression",
                b = "Improved Corruption",
                c = "Improved Curse of Weakness",
                d = "Improved Drain Soul",
                e = "Improved Life Tap",
                f = "Soul Siphon",
                g = "Fel Concentration",
                h = "Improved Curse of Agony",
                j = "Amplify Curse",
                k = "Grim Reach",
                m = "Nightfall",
                n = "Empowered Corruption",
                p = "Curse of Exhaustion",
                q = "Shadow Embrace",
                r = "Siphon Life",
                s = "Dark Pact",
                t = "Contagion",
                v = "Improved Howl of Terror",
                w = "Malediction",
                x = "Unstable Affliction",
                z = "Shadow Mastery",
            },
            [1] = {
                a = "Improved Healthstone",
                b = "Improved Imp",
                c = "Demonic Embrace",
                d = "Improved Health Funnel",
                e = "Improved Voidwalker",
                f = "Fel Intellect",
                g = "Improved Sayaad",
                h = "Fel Domination",
                j = "Fel Stamina",
                ...
                m = "Master Summoner",
                n = "Unholy Power",
                p = "Improved Subjugate Demon",
                q = "Demonic Sacrifice",
                r = "Master Conjuror",
                s = "Mana Feed",
                t = "Master Demonologist",
                v = "Demonic Resilience",
                w = "Soul Link",
                x = "Summon Felguard",
                y = "Demonic Tactics",
                z = "Demonic Knowledge",
            ...
            [2] = {
                a = "Improved Shadow Bolt",
                b = "Cataclysm",
                c = "Bane",
                d = "Aftermath",
                e = "Improved Firebolt",
                f = "Improved Lash of Pain",
                g = "Devastation",
                h = "Shadowburn",
                j = "Intensity",
                k = "Destructive Reach",
                m = "Improved Searing Pain",
                n = "Improved Immolate",
                p = "Ruin",
                q = "Pyroclasm",
                r = "Nether Protection",
        ...
        WARRIOR = {
            [0] = {
                a = "Improved Heroic Strike",
                b = "Deflection",
                c = "Improved Rend",
                d = "Improved Thunder Clap",
                e = "Iron Will",
                f = "Improved Charge",
                g = "Improved Overpower",
                h = "Anger Management",
                i = "Endless Rage",
                j = "Deep Wounds",
                k = "Two-Handed Weapon Specialization",
                m = "Impale",
                n = "Poleaxe Specialization",
                p = "Death Wish",
                q = "Mace Specialization",
                r = "Sword Specialization",
                s = "Improved Disciplines",
                t = "Improved Hamstring",
                v = "Improved Intercept",
                w = "Blood Frenzy",
                x = "Mortal Strike",
                y = "Improved Mortal Strike",
                z = "Second Wind",
            },
            [1] = {
                a = "Booming Voice",
                b = "Cruelty",
                c = "Improved Demoralizing Shout",
                d = "Unbridled Wrath",
                e = "Improved Cleave",
                f = "Piercing Howl",
                g = "Blood Craze",
                h = "Commanding Presence",
                j = "Dual Wield Specialization",
                k = "Improved Execute",
                m = "Enrage",
                n = "Improved Slam",
                p = "Sweeping Strikes",
                ...
                r = "Flurry",
                s = "Precision",
                t = "Improved Berserker Rage",
                v = "Improved Whirlwind",
                w = "Bloodthirst",
                x = "Rampage",
                z = "Improved Berserker Stance",
            },
            [2] = {
                a = "Improved Bloodrage",
                b = "Tactical Mastery",
                c = "Anticipation",
                d = "Shield Specialization",
                e = "Toughness",
                f = "Last Stand",
                g = "Improved Shield Block",
                h = "Improved Revenge",
                j = "Defiance",
                k = "Improved Sunder Armor",
                m = "Improved Disarm",
                n = "Improved Taunt",
                p = "Concussion Blow",
                q = "Improved Shield Wall",
                r = "Improved Shield Bash",
                s = "Shield Mastery",
                t = "One-Handed Weapon Specialization",
                v = "Improved Defensive Stance",
                w = "Shield Slam",
                x = "Devastate",
                y = "Vitality",
                z = "Focused Rage",
